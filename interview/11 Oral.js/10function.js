...
var obj = {
    ...
    innerMessage: !(function () {
        console.log(this.message); //undefined immediately invoked function expression (IIFE)
    })(),
};

obj.innerMessage; ///undefined
...
function myFunc() {
    console.log(this.message); //a regular function call does not set this to the function itself.
}
...
console.log(myFunc()); //undefined not returning anything
